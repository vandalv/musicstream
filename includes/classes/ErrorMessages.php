<?php 
class ErrorMassages{
    public static $usernameError = "Five to twelve characters, only letters, numbers and _ allowed";
    public static $firstnameError = "Two to twelve characters, only letters and - allowed";
